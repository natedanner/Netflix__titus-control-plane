...
public final class CallMetadataHeaders {
     ...
     */
    public static final String DEBUG_HEADER = "X-Titus-Debug";
     ...
     */
    public static final String COMPRESSION_HEADER = "X-Titus-Compression";
     ...
     */
    public static final String CALLER_TYPE_HEADER = "X-Titus-CallerType";
     ...
     */
    public static final String DIRECT_CALLER_ID_HEADER = "X-Titus-DirectCallerId";

    /**
     * Type of a caller id set in {@link #DIRECT_CALLER_ID_HEADER}.
     */
    public static final String DIRECT_CALLER_TYPE_HEADER = "X-Titus-DirectCallerType";

    /**
     * A reason for making the call. The value if set is part of the transaction log/activity history.
     */
    public static final String CALL_REASON_HEADER = "X-Titus-CallReason";
